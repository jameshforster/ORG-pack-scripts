...
craftingTable.addShapeless("ap_mekanism_bronze_dust", <item:mekanism:dust_bronze>, [<tag:forge:dusts/copper>, <tag:forge:dusts/copper>, <tag:forge:dusts/copper>, <tag:forge:dusts/tin>]);
